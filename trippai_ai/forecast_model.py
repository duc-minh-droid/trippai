"""Prophet-based forecasting model for travel predictions."""
...
class ForecastModel:
    ...
    def find_best_travel_window(
        ...
        """
        Find the best travel window accounting for trip length.
        ...
        print(f"\nFinding best travel window (trip_days={trip_days}, future_only={future_only}):")
